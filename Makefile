...
# Project:  Pong.pro
# Template: subdirs
# Command: O:\Qt\5.12.5\mingw73_64\bin\qmake.exe -o Makefile Pong.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
sub-app-qmake_all: sub-src-qmake_all FORCE
	...
	cd app\ && $(QMAKE) -o Makefile D:\ProjectsC++\Pong\app\app.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
	cd app\ && $(MAKE) -f Makefile qmake_all
sub-app: sub-src FORCE
	@if not exist app\ mkdir app\ & if not exist app\ exit 1
	cd app\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\app\app.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile
sub-app-make_first: sub-src-make_first FORCE
	@if not exist app\ mkdir app\ & if not exist app\ exit 1
	cd app\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\app\app.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile 
sub-app-all: sub-src-all FORCE
	@if not exist app\ mkdir app\ & if not exist app\ exit 1
	cd app\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\app\app.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile all
sub-app-clean: sub-src-clean FORCE
	@if not exist app\ mkdir app\ & if not exist app\ exit 1
	cd app\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\app\app.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile clean
sub-app-distclean: sub-src-distclean FORCE
	@if not exist app\ mkdir app\ & if not exist app\ exit 1
	cd app\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\app\app.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile distclean
sub-app-install_subtargets: sub-src-install_subtargets FORCE
	@if not exist app\ mkdir app\ & if not exist app\ exit 1
	cd app\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\app\app.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile install
sub-app-uninstall_subtargets: sub-src-uninstall_subtargets FORCE
	@if not exist app\ mkdir app\ & if not exist app\ exit 1
	cd app\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\app\app.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile uninstall
sub-src-qmake_all:  FORCE
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	cd src\ && $(QMAKE) -o Makefile D:\ProjectsC++\Pong\src\src.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
	cd src\ && $(MAKE) -f Makefile qmake_all
sub-src: FORCE
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	cd src\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\src\src.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile
sub-src-make_first: FORCE
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	cd src\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\src\src.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile 
sub-src-all: FORCE
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	cd src\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\src\src.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile all
sub-src-clean: FORCE
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	cd src\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\src\src.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile clean
sub-src-distclean: FORCE
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	cd src\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\src\src.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile distclean
sub-src-install_subtargets: FORCE
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	cd src\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\src\src.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile install
sub-src-uninstall_subtargets: FORCE
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	cd src\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\src\src.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile uninstall
sub-unitTest-qmake_all: sub-src-qmake_all FORCE
	@if not exist unitTest\ mkdir unitTest\ & if not exist unitTest\ exit 1
	cd unitTest\ && $(QMAKE) -o Makefile D:\ProjectsC++\Pong\unitTest\unitTest.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
	cd unitTest\ && $(MAKE) -f Makefile qmake_all
sub-unitTest: sub-src FORCE
	@if not exist unitTest\ mkdir unitTest\ & if not exist unitTest\ exit 1
	cd unitTest\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\unitTest\unitTest.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile
sub-unitTest-make_first: sub-src-make_first FORCE
	@if not exist unitTest\ mkdir unitTest\ & if not exist unitTest\ exit 1
	cd unitTest\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\unitTest\unitTest.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile 
sub-unitTest-all: sub-src-all FORCE
	@if not exist unitTest\ mkdir unitTest\ & if not exist unitTest\ exit 1
	cd unitTest\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\unitTest\unitTest.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile all
sub-unitTest-clean: sub-src-clean FORCE
	@if not exist unitTest\ mkdir unitTest\ & if not exist unitTest\ exit 1
	cd unitTest\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\unitTest\unitTest.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile clean
sub-unitTest-distclean: sub-src-distclean FORCE
	@if not exist unitTest\ mkdir unitTest\ & if not exist unitTest\ exit 1
	cd unitTest\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\unitTest\unitTest.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile distclean
sub-unitTest-install_subtargets: sub-src-install_subtargets FORCE
	@if not exist unitTest\ mkdir unitTest\ & if not exist unitTest\ exit 1
	cd unitTest\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\unitTest\unitTest.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile install
sub-unitTest-uninstall_subtargets: sub-src-uninstall_subtargets FORCE
	@if not exist unitTest\ mkdir unitTest\ & if not exist unitTest\ exit 1
	cd unitTest\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\unitTest\unitTest.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile uninstall

Makefile: Pong.pro O:/Qt/5.12.5/mingw73_64/mkspecs/win32-g++/qmake.conf O:/Qt/5.12.5/mingw73_64/mkspecs/features/spec_pre.prf \
		...
		Pong.pro
	$(QMAKE) -o Makefile Pong.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
...
qmake_all: sub-app-qmake_all sub-src-qmake_all sub-unitTest-qmake_all FORCE

make_first: sub-app-make_first sub-src-make_first sub-unitTest-make_first  FORCE
all: sub-app-all sub-src-all sub-unitTest-all  FORCE
clean: sub-app-clean sub-src-clean sub-unitTest-clean  FORCE
distclean: sub-app-distclean sub-src-distclean sub-unitTest-distclean  FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) .qmake.stash
install_subtargets: sub-app-install_subtargets sub-src-install_subtargets sub-unitTest-install_subtargets FORCE
uninstall_subtargets: sub-app-uninstall_subtargets sub-src-uninstall_subtargets sub-unitTest-uninstall_subtargets FORCE

sub-app-debug: sub-src-debug
	@if not exist app\ mkdir app\ & if not exist app\ exit 1
	cd app\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\app\app.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile debug
sub-src-debug:
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	cd src\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\src\src.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile debug
sub-unitTest-debug: sub-src-debug
	@if not exist unitTest\ mkdir unitTest\ & if not exist unitTest\ exit 1
	cd unitTest\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\unitTest\unitTest.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile debug
debug: sub-app-debug sub-src-debug sub-unitTest-debug

sub-app-release: sub-src-release
	@if not exist app\ mkdir app\ & if not exist app\ exit 1
	cd app\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\app\app.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile release
sub-src-release:
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	cd src\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\src\src.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile release
sub-unitTest-release: sub-src-release
	@if not exist unitTest\ mkdir unitTest\ & if not exist unitTest\ exit 1
	cd unitTest\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\unitTest\unitTest.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile release
release: sub-app-release sub-src-release sub-unitTest-release

sub-app-check: sub-src-check
	@if not exist app\ mkdir app\ & if not exist app\ exit 1
	cd app\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\app\app.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile check
sub-src-check:
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	cd src\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\src\src.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile check
sub-unitTest-check: sub-src-check
	@if not exist unitTest\ mkdir unitTest\ & if not exist unitTest\ exit 1
	cd unitTest\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\unitTest\unitTest.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile check
check: sub-app-check sub-src-check sub-unitTest-check

sub-app-benchmark: sub-src-benchmark
	@if not exist app\ mkdir app\ & if not exist app\ exit 1
	cd app\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\app\app.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile benchmark
sub-src-benchmark:
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	cd src\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\src\src.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile benchmark
sub-unitTest-benchmark: sub-src-benchmark
	@if not exist unitTest\ mkdir unitTest\ & if not exist unitTest\ exit 1
	cd unitTest\ && ( if not exist Makefile $(QMAKE) -o Makefile D:\ProjectsC++\Pong\unitTest\unitTest.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" ) && $(MAKE) -f Makefile benchmark
benchmark: sub-app-benchmark sub-src-benchmark sub-unitTest-benchmark
